...
pub extern "C" fn zcash_transaction_digests(
    ...
    // The branch ID argument here is a placeholder for v1-v4 transactions. V5+
    // transactions carry their own consensus branch id, which is used by
    // Transaction::read to enforce NU6.2 Orchard proof-size rules.
